...
export const metadata: Metadata = {
  ...
  description:
    'Legal framework and disclosures relating to Harmonia Fortuna. Transparency and structural integrity guide our standards.',
};
  ...
  return (
    <RootLayout>
      ...
      <div className="prose">
        ...
        <h2>6. No Warranty</h2>
        <p>
          The information provided on this website is presented &quot;as
