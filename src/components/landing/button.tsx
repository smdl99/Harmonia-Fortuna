...
const buttonVariants = cva('inline-flex items-center cursor-pointer', {
  variants: {
    variant: {
      default:
        'text-secondary-foreground relative after:absolute after:w-full after:h-[1px] after:bg-secondary after:bottom-0 after:origin-left after:scale-x-0 hover:after:scale-x-100 after:transition-transform transition-colors after:duration-300',
      outline:
